  ...
  return (
    <div>
      ...
      <div className='flex flex-col sm:flex-row items-start gap-5 mt-5'>
        ...
        <p
  onClick={() => speciality === "Geneal Physician" ? navigate('/doctors') : navigate('/doctors/Geneal Physician')}
  className={`w-[94vw] sm:w-auto pl-3 py-1.5 pr-16 border border-gray-300 rounded transition-all cursor-pointer ${speciality === "Geneal Physician" ? "bg-indigo-100 text-black" : ""}`}
>
  Geneal Physician
</p>
...
<p
  onClick={() => speciality === "Gastroenterlogist" ? navigate('/doctors') : navigate('/doctors/Gastroenterlogist')}
  className={`w-[94vw] sm:w-auto pl-3 py-1.5 pr-16 border border-gray-300 rounded transition-all cursor-pointer ${speciality === "Gastroenterlogist" ? "bg-indigo-100 text-black" : ""}`}
>
  Gastroenterlogist
</p>
